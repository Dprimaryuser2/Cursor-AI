...
checkout_heading = '//h5[contains(text(),"Checkout")]'
checkout_heading_return = '//div[@class="col-md-4 col-lg-6 col-4"]/h5'
# payment method
...
invoice_no = '//td//b//pre[contains(text(),"Invoice No : ")]'
number_invoice = '//td//span//pre[contains(text()," Customer Mobile : ")]'
...
invoice_amount = '//td//b//pre[contains(text()," Customer Paid: ")]'
