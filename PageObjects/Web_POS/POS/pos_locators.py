...
select_search_invoice_option_btn = '//div[@class="dropdown b-dropdown switch-billing fs-12 mr-3 show btn-group"]//button[@class="btn dropdown-toggle btn-light"]'
select_search_invoice_option = '//ul[@class="dropdown-menu dropdown-menu-right show"]//li[@class="fs-13"]//a[contains(text(),"Invoice Number")]'
