...
initial_product_in_exc_cart = '//tbody[@role="rowgroup"]//td[@aria-colindex="2"  and descendant::p[@class="text-success my-1 mb-0"]  or  descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged"]]//ancestor::td[@aria-colindex="2"]//div//a'
initial_product_net_price_in_exc_cart = '//tbody[@role="rowgroup"]//td[@aria-colindex="2"  and descendant::p[@class="text-success my-1 mb-0"]  or  descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged"]]//ancestor::td[@aria-colindex="2"]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="6"]'
...
initial_product_qty_in_exc_cart = '//tbody[@role="rowgroup"]//td[@aria-colindex="2"  and descendant::p[@class="text-success my-1 mb-0"]  or  descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged"]]//ancestor::td[@aria-colindex="2"]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="3"]'
