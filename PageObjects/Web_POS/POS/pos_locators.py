...
disabled_apply_override_button = '//button[@class="btn btn-primary disabled"]//span[contains(text(),"Apply Override")]'
...
selected_parameter_invoice_option = '//div[@class="d-flex align-items-center justify-content-end col-1"]//button[@class="btn dropdown-toggle btn-light"]'
...
alternate_product_in_exc_cart = '//tbody[@role="rowgroup"]//td[@aria-colindex="2" and not(descendant::p) and not(descendant::button)]//div//a'
disabled_alternate_product_qty_in_exc_cart= '//tbody[@role="rowgroup"]//td[@aria-colindex="2" and not(descendant::p) and not(descendant::button)]//ancestor::tr[@role="row"]//descendant::select[@disabled="disabled"]//option[1]'
alternate_product_net_price = '//tbody[@role="rowgroup"]//td[@aria-colindex="2" and not(descendant::p) and not(descendant::button)]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="6"]'
alternate_product_discount_price = '//tbody[@role="rowgroup"]//td[@aria-colindex="2" and not(descendant::p) and not(descendant::button)]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="5"]'
alternate_product_price = '//tbody[@role="rowgroup"]//td[@aria-colindex="2" and not(descendant::p) and not(descendant::button)]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="4"]'
initial_product_in_exc_cart = '//tbody[@role="rowgroup"]//td[@aria-colindex="2"  and descendant::p[@class="text-success my-1 mb-0"]  or descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged cancel-prod-exchanged"] or descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged"]]//ancestor::td[@aria-colindex="2"]//div//a'
initial_product_net_price_in_exc_cart = '//tbody[@role="rowgroup"]//td[@aria-colindex="2"  and descendant::p[@class="text-success my-1 mb-0"]  or descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged cancel-prod-exchanged"] or  descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged"]]//ancestor::td[@aria-colindex="2"]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="6"]'
initial_product_discount_price = '//tbody[@role="rowgroup"]//td[@aria-colindex="2"  and descendant::p[@class="text-success my-1 mb-0"]  or  descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged"]]//ancestor::td[@aria-colindex="2"]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="5"]'
initial_product_qty_in_exc_cart = '(//tbody[@role="rowgroup"]//td[@aria-colindex="2"  and descendant::p[@class="text-success my-1 mb-0"]  or  descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged cancel-prod-exchanged"] or descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged"]]//ancestor::td[@aria-colindex="2"]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="3"]//select//option)[1]'
initial_product_price_in_exc_cart= '//tbody[@role="rowgroup"]//td[@aria-colindex="2"  and descendant::p[@class="text-success my-1 mb-0"]  or  descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged"]]//ancestor::td[@aria-colindex="2"]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="4"]'
...
exchange_product_net_price = '//tbody[@role="rowgroup"]//td[@aria-colindex="2"  and descendant::p[@class="text-success my-1 mb-0"]  or  descendant::button[@class="primary-light fs-12 my-1 add-prod-exchanged"]]//ancestor::td[@aria-colindex="2"]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="6"]'
...
closing_balance_force_session_close = '//input[@placeholder="Enter closing balance"]'
