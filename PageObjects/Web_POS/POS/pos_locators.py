...
alternate_product_in_net_price = '//a[@class="product-name text-danger"]//ancestor::tr[@class="b-table-row-outofstock border-bottom-0"]//descendant::td[@aria-colindex="6"]'
initial_product_in_exc_cart = '//a[@class="product-name"]'
initial_product_qty_in_exc_cart = '//a[@class="product-name"]//ancestor::tr[@role="row"]//descendant::td[@aria-colindex="6"]'